...
function SignIn({history}) {
    ...
    e.preventDefault()
    console.log(socket)
    const ids = socket._id
    console.log()
    socket.emit("signin",({ids,name,useremail,password}))
    socket.on('exsistingemail',()=>{
        history.push('/')
    })
    socket.on('signedup',(saveUser)=>{
    ...
    return (
        ...
        <Paper className="paper">
            ...
            >
                ...
                <div className="input__div">
            <input type="text" className="input" value={useremail} onChange={(e)=>setUseremail(e.target.value)} placeholder="Enter Email"/>
            </div>
            <div className="input__div">
