...
const Login = ({history}) => {
    ...
    e.preventDefault()
    console.log(socket)
    socket.emit("check",({name,password}))
    socket.on("menu",((db)=>{
        console.log(db)
        // console.log(db._id,",",password,",",db.password)
        if(db){
                history.push(`/dashboard/${db._id}`)
        }
        

    }))
    socket.on("wrongcredential",()=>{
    ...
    return (
        ...
        <Paper className="paper">
            ...
            <input className="input" type="text" value={name} onChange={(e)=>setName(e.target.value)} placeholder="Enter Email"/>
